...
const addAmountToBalance = `-- name: AddAmountToBalance :one
Update accounts
...
type AddAmountToBalanceParams struct {
	Amount int64 `json:"amount"`
	ID     int64 `json:"id"`
}

func (q *Queries) AddAmountToBalance(ctx context.Context, arg AddAmountToBalanceParams) (Accounts, error) {
	row := q.db.QueryRowContext(ctx, addAmountToBalance, arg.Amount, arg.ID)
	var i Accounts
	err := row.Scan(
		&i.ID,
		&i.Owner,
